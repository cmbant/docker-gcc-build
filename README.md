...
This is a fork of [cmbant/docker-gcc-build](https://github.com/cmbant/docker-gcc-build)
that updates the docker image with the latest GCC trunk automatically
every night, using [nightly-docker-rebuild].
...
standard mpich and basic build tools.
